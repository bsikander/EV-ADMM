...
public class Result {
	...
	public Result(String peerName, int iteration, int ev_number,
			double[] x_old, double[] xMean, double[] u, double[] x_optimal,
			double costvalue) {
	...
	public String printResult() {
		...
		String print = this.peerName + " \t " + this.Iteration + " \t\t "
				+ this.EV_number + " \t " + this.cost_value + " \t " + sum
				+ " \t " + sumxold + " \t " + sumxMean + " \t " + sumu;
