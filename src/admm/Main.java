...
public class Main {
	public static void main(String[] args) throws IOException,
		...
		try {
			...
			job.set(Constants.EVADMM_EV_COUNT, "20");
			job.set(Constants.EVADMM_OUTPUT_PATH,
					"/Users/raja/Documents/workspace/Hama-EVADMM/output/");
			job.set(Constants.EVADMM_AGGREGATOR_PATH,
					"/Users/raja/Documents/Thesis/ADMM_matlab/Aggregator/aggregator.mat");
			job.set(Constants.EVADMM_EV_PATH,
					"/Users/raja/Documents/Thesis/ADMM_matlab/Valley_Filling_1.1/Jose/EVs/home/");
			job.set(Constants.EVADMM_RHO, "0.01");
			job.set(Constants.EVADMM_BSP_TASK, "5");
			...
			List<String> partitionedFiles = PartitionInputData.partitionData(
					new Path(job.get(Constants.EVADMM_EV_PATH)), // The path to
																	// the
																	// complete
																	// EVADMM
																	// file
					job.getInt(Constants.EVADMM_BSP_TASK, 0) - 1, // Total BSP
																	// tasks
																	// that user
																	// wants - 1
																	// (for
																	// master)
					job.getInt(Constants.EVADMM_EV_COUNT, 0), // Total EVs that
																// are being
																// processed
																// currently
					conf, // Current configuration of Hama
					"/Users/raja/Documents/workspace/Hama-EVADMM/partition/" // For
																				// local
			// "/Partition/" //For cluster
					);

			String inputPath = "/Users/raja/Documents/workspace/Hama-EVADMM/empty.txt,"; // For
																							// local
			...
			job.setNumBspTask(Integer.parseInt(job
					.get(Constants.EVADMM_BSP_TASK)));
	...
	/*
	 * In case user is not using the command line parameters properly. This
	 * function prints the correct usage information.
	 */
	private static void printUsage() {
		System.out
				.println("Usage: <input_aggregator> <input_ev> <output> "
