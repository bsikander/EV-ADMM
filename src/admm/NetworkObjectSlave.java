...
public class NetworkObjectSlave implements Writable {
	 ...
	 */
	// public NetworkObjectSlave(double[] x_i, int EVId, double[]
	// x_i_difference, double cost)
	...
	public void readFields(DataInput in) throws IOException {
		...
		setNetworkObjectSlave(OBJECT_MAPPER.readValue(contextJson.toString(),
				NetworkObjectSlave.class));
	}
