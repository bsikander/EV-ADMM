...
public class SlaveData {
	...
	/*
	 * The default constructor which takes all the objects as parameters that
	 * were loaded from file system for a single EV.
	 */
	// public SlaveData(double[] d, double[] A, double[][] B, double R, double[]
	// Smax, double[] Smin)
	public SlaveData(double[] d, double[] A, double R) {
		this.d = d;
		this.A = A;
		// this.B = B;
		this.R = R;
